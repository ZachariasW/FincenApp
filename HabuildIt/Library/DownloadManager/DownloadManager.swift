...
@objcMembers class DownloadManager: NSObject {
    ...
    @discardableResult
    @objc func addDownload(_ url: URL, mainFolder: String, subFolder: String) -> DownloadOperation {
        let operation = DownloadOperation(session: session, url: url,mainFolder: mainFolder, subFolder: subFolder)
