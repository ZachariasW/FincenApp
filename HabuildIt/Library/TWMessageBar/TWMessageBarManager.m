...
- (TWMessageBarViewController *)messageBarViewController
{
    if (!self.messageWindow) {
        ...
        //self.messageWindow.frame = [[AppConstants.getKeyWindow] frame];
...
- (CGRect)statusBarFrame
{
    CGRect windowFrame = NSFoundationVersionNumber <= NSFoundationVersionNumber_iOS_7_1 ? [self orientFrame:AppConstants.getKeyWindow.frame] : AppConstants.getKeyWindow.frame;
//    CGRect statusFrame = NSFoundationVersionNumber <= NSFoundationVersionNumber_iOS_7_1 ?  [self orientFrame:[UIApplication sharedApplication].statusBarFrame] : [UIApplication sharedApplication].statusBarFrame;
    if (@available(iOS 13.0, *)) {
        CGRect statusFrame = NSFoundationVersionNumber <= NSFoundationVersionNumber_iOS_7_1 ?  [self orientFrame:[AppConstants getKeyWindow].windowScene.statusBarManager.statusBarFrame] : [AppConstants getKeyWindow].windowScene.statusBarManager.statusBarFrame;
